        ...
        <div id="create-solicitudReserva" class="content scaffold-create" role="main">
            ...
            <g:form action="save">
                <fieldset class="form">
                    ...
                    <!--<div class="form-group row justify-content-center" bean="solicitudReserva" property="tipoAutomovil" >
                        <label for="example-text-input" class="col-1 col-form-label">Tipo Automovil</label>
                        <div class="col-3">
                            <g:select class="form-control" name="tipoAutomovil" value="${solicitudReservaInstance?.tipoAutomovil}" from="${solicitudReserva.getConstrainedProperties().tipoAutomovil.inList}"  valueMessagePrefix="tipoAutomovil" required="true"/>
                        </div>
                    </div>-->
