...
<html>
    <head>
        ...
        <title>Solicitudes de habitaciones pendientes</title>
    </head>
    <body>
        <div id="list-solicitudHabitacion" class="content scaffold-list" role="main">
            <h1>Solicitudes de Habitaciones pendientes</h1>
            ...
            <table class="table table-sm" collection="${solicitudHabitacionList}">
                <tbody>
                    <thead>
                        ...
                        <g:sortableColumn property="fechaInicio" title="Fecha de Ingreso"><th scope="col"></th></g:sortableColumn>
                        <g:sortableColumn property="fechaFin" title="Fecha de Egreso"><th scope="col"></th></g:sortableColumn>
                        <g:sortableColumn property="cantidadHuespedes" title="Cantidad de Huespedes"><th scope="col"></th></g:sortableColumn>
                        <th scope="col">Opciones</th>
                    </thead>
                <g:each in="${solicitudHabitacionList}" var="solicitudReserva">
                <tr>
                    ...
                    <g:form resource="${solicitudReserva}" method="DELETE">
                        ...
                        <!--<g:link class="badge badge-success" action="aceptarSolicitud" >Aceptar <i class="fa fa-check" aria-hidden="true"></i></g:link>-->

                        <g:actionSubmit type="button" class="btn-danger" value="Rechazar" action="delete" params="${solicitudReserva}"/>
            ...
            <div class="pagination">
                <g:paginate total="${solicitudHabitacionCount ?: 0}" />
            </div>
        </div>
    </body>
</html>